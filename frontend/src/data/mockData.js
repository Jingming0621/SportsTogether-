...
export const games = [
    ...
    },
    {
        ...
        organizer: usersArray[0],
        roster: [usersArray[0]],
        description: "Casual 3v3 pickup games.",
        requirements: "None",
        image: "https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400"
    },
    {
        id: 8,
        sportType: "Running",
        title: "Morning Jog @ Botanical",
        date: "2025-12-18",
        time: "07:00",
        venue: "Botanical Gardens",
        venueAddress: "Jalan Kebun Bunga",
        area: "George Town",
        cost: 0.00,
        maxPlayers: 20,
        currentPlayers: 5,
        status: "Open",
        organizer: usersArray[1],
        roster: [usersArray[1], usersArray[3]],
        description: "5km easy pace jog.",
    ...
    },
    {
        ...
        status: "Open",
        organizer: usersArray[3],
        roster: [usersArray[3], usersArray[2]],
