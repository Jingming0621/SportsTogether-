...
import './InstructorMarketplace.css';
                        ...
                        {instructors.map(instructor => (
                            <div key={instructor.id} className="instructor-card">
                                <div className="instructor-header-card">
                                    <img src={instructor.avatar} alt="" className="instructor-avatar" />
                                    {instructor.verified && (
                        ...
                        <div className="booking-container">
                            <div className="booking-instructor-info">
                                ...
                                <div>
                                    ...
                                    <div className="booking-price">RM {selectedInstructor.hourlyRate}/session</div>
                                </div>
                            </div>
